...
#Data Loading
data=pd.read_csv('training/airline_sentiment_analysis.csv')
...
print(obj.predict('Nice service and good behaviour'))
print(obj.predict('Bad behaviour and worst services'))
